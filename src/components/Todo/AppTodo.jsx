...
function AppTodo() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-100 to-indigo-200 px-4 py-6">
        <div className="bg-white shadow-xl rounded-2xl p-6 sm:p-8 w-full max-w-md mx-auto">
          {/* Heading */}
